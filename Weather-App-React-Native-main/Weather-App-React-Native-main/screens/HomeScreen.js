...
export default function HomeScreen() {
  ...
  // Function to handle search input and fetch locations
  ...
  // Function to handle selecting a location and fetching weather data
  ...
  // Function to fetch weather data based on user's city preference
  ...
  // Debounced search function to avoid frequent API calls while typing
  const handleTextDebounce = useCallback(debounce(handleSearch, 1200), []);

  // Destructuring weather data for easier access
      ...
      {loading ? (
        ...
        <SafeAreaView className="flex flex-1">
          ...
          <View style={{ height: '7%' }} className="mx-4 relative z-50">
            <View
              ...
              <TouchableOpacity
                ...
                {showSearch ? (
                  // Show XMarkIcon when searching, MagnifyingGlassIcon otherwise
          ...
          <View className="mb-2 space-y-3">
            ...
            {/* Scrollable view for daily forecast */}
            <ScrollView
              horizontal
